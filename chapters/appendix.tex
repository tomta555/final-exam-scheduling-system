...
\begin{table}[h]
  ...
  \end{tabular}
  \caption{ตารางแสดงรหัสคณะและรายชื่อคณะภายในมหาวิทยาลัยเชียงใหม่ \cite{cmu-faculties}}
...
\\ โดยในโฟลเดอร์ \str{project\_resources} จะมีโฟลเดอร์ย่อยต่าง ๆ ดังนี้ 
\begin{itemize}
  ...
  \item \str{questionnaires\_result} เก็บไฟล์สรุปรวมผลการสอบถามความคิดเห็นของนักศึกษาเพื่อประเมินระบบ
