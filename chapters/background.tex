...
ซึ่งหมายความว่า\CI{ไม่มี}{ผิด}อัลกอริทึมที่ใช้เวลา polynomial-time ในการแก้ไขปัญหาให้ได้ผลลัพธ์ที่เหมาะสมที่สุด 
...
ซึ่งวิธีการนั้นคือ Metaheuristic Algorithms ซึ่ง\CI{ใช้เวลาในการแก้ปัญหาน้อยกว่าวิธี Graph Coloring}{รู้ได้อย่างไร \enskip cite?} และสามารถกำหนดข้อจำกัดหรือเงื่อนไขอื่นเพิ่มเติมได้แต่อาจจะไม่ได้วิธีแก้ปัญหาที่ดีที่สุด
\section{Tools}
