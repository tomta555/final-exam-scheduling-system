...
ซึ่งหมายความว่าไม่มีอัลกอริทึมที่ใช้เวลา polynomial-time ในการแก้ไขปัญหาให้ได้ผลลัพธ์ที่เหมาะสมที่สุด 
...
ซึ่งวิธีการนั้นคือ Metaheuristic Algorithms ซึ่งใช้เวลาในการแก้ปัญหาน้อยกว่าวิธี Graph Coloring และสามารถกำหนดข้อจำกัดหรือเงื่อนไขอื่นเพิ่มเติมได้แต่อาจจะไม่ได้วิธีแก้ปัญหาที่ดีที่สุด
\section{Tools}
