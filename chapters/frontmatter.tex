...
In this study, we have designed four types of algorithms in which each type differs in the order of nodes to coloring.
All variety of algorithms take approximately 90 seconds to produce an exam schedule for one semester.
Moreover, we have the students take part in system assessment by taking questionnaires, having students pick their exam schedule they like the most between exam schedule from the system and exam schedule from the registration office in each semester between 2018--2020.
The result is that more than 60 percent of students choose exam schedules from the system over exam schedules from the registration office. 
